# Requirements Archive: v2.0 AWS Migration
...
- [x] **AI-01**: Bedrock invokes Claude with correct model ID format (`anthropic.claude-sonnet-4-20250514-v1:0`) — validated by smoke test
...
- [x] **AI-04**: Bedrock model access enabled in us-east-1 (FTU form completed) — validated by smoke test
