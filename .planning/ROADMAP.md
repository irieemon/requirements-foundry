...
**Plans**: 5 plans
Plans:
- [x] 21-01-PLAN.md — Package swap, Dockerfile, db.ts simplification, health check
- [x] 21-02-PLAN.md — S3 storage adapter, Prisma column rename, upload flow migration
- [x] 21-03-PLAN.md — Bedrock AI provider, credential auto-detection, document-analyzer/question-generator
- [x] 21-04-PLAN.md — Self-continuation elimination, Vercel reference purge
- [ ] 21-05-PLAN.md — Gap closure: fix hasAnthropicKey references, remove Vercel comment from schema
...
| 25. Validation and Data Migration | v2.0 | 1/3 | In Progress | - |
